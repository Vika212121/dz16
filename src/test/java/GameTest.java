...
class GameTest {
    ...
    public void shouldRegister() {
        ...
        Player player2 = new Player(2, "Петя", 100);
    ...
    public void shouldNotRegisteredException2() {
        Player player2 = new Player(1, "Коля", 100);
        game.register(player2);
        Assertions.assertThrows(NotRegisteredException.class, () -> game.round(null, player2));
    }
    ...
    public void shouldPlayer1Win() {
        Player player1 = new Player(1, "Коля", 150);
        Player player2 = new Player(2, "Петя", 100);
        game.register(player1);
        game.register(player2);
        int expected = 1;
